...
/** The multi-color Google "G" mark, per Google's official brand SVG. */
export function GoogleIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      <path
        fill="#FBBC05"
        d="M5.27 14.29c-.25-.72-.38-1.49-.38-2.29s.14-1.57.38-2.29V6.62H1.29A11.94 11.94 0 000 12c0 1.92.46 3.73 1.29 5.38l3.98-3.09z"
      />
      <path
        fill="#EA4335"
