// Circular flag icons vendored from HatScripts/circle-flags
// (https://github.com/HatScripts/circle-flags, MIT). Flat geometric style
// sized for icon buttons; mask ids are prefixed per flag so SE and GB can
...
export function SwedenFlag({ className }: FlagProps) {
  return (
    <svg
      ...
      focusable="false"
    >
      <mask id="flag-se-mask">
        <circle cx="256" cy="256" r="256" fill="#fff" />
      </mask>
      <g mask="url(#flag-se-mask)">
        <path
          fill="#0052b4"
