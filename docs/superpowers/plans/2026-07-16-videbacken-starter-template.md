...
- Modify: remaining ADRs (prune boat references), `docs/adr/0017`→ rewrite as auth ADR (or new file), `CLAUDE.md`, `README.md`, `AGENTS.md`, `docs/feature-workflow.md`/`refactor-workflow.md` (prune boat examples)
...
**Interfaces:**
- Produces: a coherent doc set + green, self-contained CI (no Neon secrets required).
